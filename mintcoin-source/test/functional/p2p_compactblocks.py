...
# TestP2PConn: A peer we use to send messages to mintcoind, and store responses.
...
class CompactBlocksTest(MintcoinTestFramework):
    ...
    # This test actually causes mintcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that mintcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for mintcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # mintcoind will not send blocktxn responses for blocks whose height is
