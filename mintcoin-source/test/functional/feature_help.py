...
"""Verify that starting mintcoin with -h works as expected."""

from test_framework.test_framework import MintcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MintcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mintcoin with -h for help text")
        ...
        self.log.info("Start mintcoin with -version for version information")
        ...
        self.log.info("Start mintcoind with -fakearg to make sure it does not start")
