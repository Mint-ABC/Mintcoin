Mintcoin Core version 0.17.1 is now available from:

  <https://mintcoincore.org/bin/mintcoin-core-0.17.1/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/mintcoin/mintcoin/issues>

To receive security and update notifications, please subscribe to:

  <https://mintcoincore.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Mintcoin-Qt` (on Mac)
or `mintcoind`/`mintcoin-qt` (on Linux).
...
Mintcoin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer (Windows XP is not supported).

Mintcoin Core should also work on most other Unix-like systems but is not
...
When mintcoin is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add mintcoin-tx.exe into Windows installer (ken2812221)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mintcoin/).
