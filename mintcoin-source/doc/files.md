...
* mintcoin.conf: contains configuration settings for mintcoind or mintcoin-qt
* mintcoind.pid: stores the process id of mintcoind while running
...
* debug.log: contains debug information and general logging generated by mintcoind or mintcoin-qt
