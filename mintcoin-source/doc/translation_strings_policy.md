...
This document provides guidelines for internationalization of the Mintcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mintcoin_en.ts` remains unchanged.
