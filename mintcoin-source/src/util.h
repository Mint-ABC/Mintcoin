 ...
 */
#ifndef MINTCOIN_UTIL_H
#define MINTCOIN_UTIL_H
...
extern const char * const MINTCOIN_CONF_FILENAME;
extern const char * const MINTCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("mintcoin-%s", name);
