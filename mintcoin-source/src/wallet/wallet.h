...
#ifndef MINTCOIN_WALLET_WALLET_H
#define MINTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this mintcoin node, and set to 0 for transactions that were created
...
#endif // MINTCOIN_WALLET_WALLET_H
