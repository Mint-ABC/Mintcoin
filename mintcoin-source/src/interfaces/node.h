...
#ifndef MINTCOIN_INTERFACES_NODE_H
#define MINTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a mintcoin node (mintcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MINTCOIN_INTERFACES_NODE_H
