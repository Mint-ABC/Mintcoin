...
static void SetupMintcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mintcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mintcoin-tx [options] <hex-tx> [commands]  Update hex-encoded mintcoin transaction\n" +
            "or:     mintcoin-tx [options] -create [commands]   Create hex-encoded mintcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mintcoin transaction
