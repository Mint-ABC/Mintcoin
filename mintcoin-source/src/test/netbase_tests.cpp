...
{
    BOOST_CHECK(TestSplitHost("www.mintcoincore.org", "www.mintcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.mintcoincore.org]", "www.mintcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.mintcoincore.org:80", "www.mintcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mintcoincore.org]:80", "www.mintcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:29392", "127.0.0.1", 29392));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29392", "127.0.0.1", 29392));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29392", "::ffff:127.0.0.1", 29392));
    BOOST_CHECK(TestSplitHost("[::]:29392", "::", 29392));
    BOOST_CHECK(TestSplitHost("::29392", "::29392", -1));
    BOOST_CHECK(TestSplitHost(":29392", "", 29392));
    BOOST_CHECK(TestSplitHost("[]:29392", "", 29392));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29392", "127.0.0.1:29392"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29392", "[::]:29392"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
