...
#ifndef MINTCOIN_TEST_SCRIPTNUM10_H
#define MINTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mintcoin Core 0.10.0, for cross-comparison.
 */
public:
