...
#ifndef MINTCOIN_KEYSTORE_H
#define MINTCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/mintcoin/bips/blob/master/bip-0013.mediawiki
