    ...
    mapper(0)
{
    ...
    ui->mintcoinAtStartup->setToolTip(ui->mintcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->mintcoinAtStartup->setText(ui->mintcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMintcoinConfButton->setToolTip(ui->openMintcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MintcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mintcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMintcoinConfButton_clicked()
{
