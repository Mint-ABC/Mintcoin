...
#ifndef MINTCOIN_QT_MINTCOINUNITS_H
#define MINTCOIN_QT_MINTCOINUNITS_H
...
/** Mintcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MintcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MintcoinUnits(QObject *parent);

    /** Mintcoin units.
      @note Source: https://en.mintcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MTC,
...
typedef MintcoinUnits::Unit MintcoinUnit;

#endif // MINTCOIN_QT_MINTCOINUNITS_H
